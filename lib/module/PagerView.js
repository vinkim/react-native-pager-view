...
export class PagerView extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement(PagerViewViewManager, Object.assign({}, this.props, {
...
//# sourceMappingURL=PagerView.js.map onMoveShouldSetResponderCapture: this._onMoveShouldSetResponderCapture,
      children: childrenWithOverriddenStyle(this.props.children)
    }));
  }
