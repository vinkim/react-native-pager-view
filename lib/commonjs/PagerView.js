...
class PagerView extends _react.default.Component {
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement(_PagerViewNative.PagerViewViewManager, { ...this.props,
...
//# sourceMappingURL=PagerView.js.mapStateChanged: this._onPageScrollStateChanged,
      onPageSelected: this._onPageSelected,
      onMoveShouldSetResponderCapture: this._onMoveShouldSetResponderCapture,
      children: (0, _utils.childrenWithOverriddenStyle)(this.props.children)
    }));
