...
class LazyPagerView extends _react.default.PureComponent {
  constructor() {
    super(...arguments);
    this.pagerImplRef = /*#__PURE__*/_react.default.createRef();
  }
  ...
  setScrollLocked(scrollLocked) {
    var _this$pagerImplRef$cu4;

    (_this$pagerImplRef$cu4 = this.pagerImplRef.current) === null || _this$pagerImplRef$cu4 === void 0 ? void 0 : _this$pagerImplRef$cu4.setScrollLocked(scrollLocked);
  }
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: style
    }, /*#__PURE__*/_react.default.createElement(LazyPagerViewImpl, Object.assign({}, implProps, {
...
class LazyPagerViewImpl extends _react.default.Component {
  ...
  setScrollLocked(scrollLocked) {
    _reactNative.UIManager.dispatchViewManagerCommand((0, _reactNative.findNodeHandle)(this), (0, _PagerViewNative.getViewManagerConfig)().Commands.setScrollLocked, [scrollLocked]);
  }
  /**
...
//# sourceMappingURL=LazyPagerView.js.maproll: this.onPageScroll,
      onPageScrollStateChanged: this.onPageScrollStateChanged,
      onPageSelected: this.onPageSelected,
      orientation: this.props.orientation,
      overdrag: this.props.overdrag,
